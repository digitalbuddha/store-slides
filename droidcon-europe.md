![](/Users/Nakhimovich/Desktop/Screen Shot 2017-04-01 at 8.40.42 AM.png)
...
![](computerScreen.jpg)
# The Act of getting data from an external system on to a user's screen
---
...
#**_snowflake_**
![](/Users/Nakhimovich/Desktop/Screen Shot 2017-04-01 at 8.35.44 AM.png)
...
---
![](nytimes.jpg)
# [fit] How do we work with Data
---
#[fit] **80% case**:
# Need data, don't care if  fresh or cached
---
#[fit] Need fresh Data for 
##**background updates** & 
##**pull to refresh**
---
...
## ![inline](rxjava.png) Data Should be Observable ![inline](rxjava.png)
...
# [fit]How does it flow?
 ![inline filtered](https://github.com/nytm/Store/raw/master/Images/store-1.jpg)  
...
![fit inline filtered](https://github.com/nytm/Store/raw/master/Images/store-2.jpg)
...
public class PriceList {
  ...
  void updatePizzaPrice(int newPrice){
  api.updatePizzaPrice(prices)
...
---
![](buildingstore.jpg)
## **Customizing and Building a Store**
### is done by Implemening and suppling Parts to a Builder.
---
# **Parts/Interfaces**
```java
Fetcher<Raw, Key>
...
```
---
# Parsers help with APIs that don't return View Models
---
...
![fit inline filtered](https://github.com/nytm/Store/raw/master/Images/store-3.jpg)

---
#[fit]Offline should be a configuration!
#[fit] Let's create a Persister
---
...
![fit inline filtered](https://github.com/nytm/Store/raw/master/Images/store-5.jpg)
...
---
###Step 1: Subscribe to Store and Filter for what you do not need
```java
